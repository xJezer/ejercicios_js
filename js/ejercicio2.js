...
let condition = variable[Math.floor(Math.random() * variable.length)];

console.log("let's try your luck, your number needs to be " + condition + " to win");

if (ramBer < 10 && condition === "< 10") {
    console.log("You win! Your number is less than 10.");
}else if (ramBer < 50 && condition === "< 50") {
    console.log("You win! Your number is less than 50.");
}else if (ramBer > 75 && condition === "> 75") {
